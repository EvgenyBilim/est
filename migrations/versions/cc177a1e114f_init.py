...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['parent_uuid'], ['locations.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    op.create_table('agreement_types',
    sa.Column('uuid', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('housing_class', sa.Enum('ECONOMIC', 'COMFORT', 'BUSINESS', 'PREMIUM', name='housingclassenum'), nullable=False),
    sa.Column('parking_types', postgresql.ARRAY(sa.Enum('OPEN', 'COVERED', 'UNDERGROUND', name='parkingtypeenum')), nullable=False),
    ...
    sa.Column('coordinates', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=True),
    ...
    op.create_table('bank_programs_homes',
    sa.Column('uuid', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    sa.Column('wall_type', sa.Enum('BRICK_MONOLITH', 'MONOLITH', 'BRICK', 'PANEL', name='walltypeenum'), nullable=False),
    ...
    sa.Column('wall_types', postgresql.ARRAY(sa.Enum('BRICK_MONOLITH', 'MONOLITH', 'BRICK', 'PANEL', name='walltypeenum')), nullable=True),
    sa.Column('trim_types', postgresql.ARRAY(sa.Enum('NO_TRIM', 'PARTIAL', 'FULL', name='trimtypeenum')), nullable=True),
    sa.Column('bathroom_types', postgresql.ARRAY(sa.Enum('UNIFIED', 'SEPARATED', 'TWO_AND_MORE', name='bathroomtypeenum')), nullable=True),
    ...
    op.create_index('ix_homes_info_agreement_types', 'home_info', ['agreement_types'], unique=False, postgresql_using='gin')
    ...
    op.create_table('home_locations',
    ...
    op.create_table('home_payment_types',
    sa.Column('home_uuid', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_home_payment_types_payment_type_uuid'), 'home_payment_types', ['payment_type_uuid'], unique=False)
    op.create_table('home_tags',
    sa.Column('home_uuid', sa.UUID(), nullable=False),
    ...
    op.create_index('ix_home_tags_tag_trgm', 'home_tags', ['tag'], unique=False, postgresql_using='gin', postgresql_ops={'tag': 'gin_trgm_ops'})
    ...
    sa.Column('rooms', sa.Enum('STUDIO', 'ONE', 'TWO', 'THREE', 'FOUR', 'FIVE', 'MORE', 'FREE', name='roomtypeenum'), nullable=False),
    ...
    sa.Column('bathroom_type', sa.Enum('UNIFIED', 'SEPARATED', 'TWO_AND_MORE', name='bathroomtypeenum'), nullable=False),
    ...
    op.create_table('home_metro_stations',
    sa.Column('uuid', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('home_uuid', sa.UUID(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index('ix_home_tags_tag_trgm', table_name='home_tags', postgresql_using='gin', postgresql_ops={'tag': 'gin_trgm_ops'})
